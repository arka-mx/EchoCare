...
function Hero() {
  ...
  return (
    <div className="min-h-[80vh] py-20  flex flex-col items-center justify-center gap-8 relative overflow-hidden">
      ...
      <h2 className="text-[#192E46]/80 text-lg md:text-xl text-center max-w-2xl mx-3 font-medium">
        EchoCare records doctor-patient conversation and converts them into
        structured SOAP notes - ready to review and export
      </h2>
      <button
        className={`flex items-center text-[1.1rem] gap-3 bg-[#2E5674] px-6 py-2 text-white rounded-lg hover:bg-[#192E46] transition-colors cursor-pointer ${isLoggingIn ? "opacity-75 pointer-events-none" : ""
          }`}
        onClick={handleLogin}
      >
